...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($draft) {
            ...
            $stmt = $pdo->prepare("INSERT INTO posts (user_id, category_id, canton, therapist, designation, title, content, tags, is_published, is_active, is_banned, is_deactivated)
                                   VALUES (:user_id, :category, :canton, :therapist, :designation, :title, :content, :tags, 0, 0, 0, 0)");
            $stmt->execute([
                'user_id' => $user_id,
