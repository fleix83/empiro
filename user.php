                ...
                ?>
                    <li class="blocked-user-item d-flex align-items-center" data-user-id="<?= $blockedUser['id'] ?>">
                        ...
                        <form action="user.php" method="post" class="ms-auto">
                            ...
                            <button type="submit" class="btn btn-sm btn-danger unblock-btn">Unblock</button>
                        </form>
                    </li>
                <?php endforeach; ?>
            </ul>
                ...
                <div class="tab-pane fade show active" id="drafts" role="tabpanel" aria-labelledby="drafts-tab">
                    <?php if ($drafts): ?>
                        <?php foreach ($drafts as $draft): ?>
                            <div class="user-draft-post d-flex flex-column justify-content-between align-items-start mb-3">
                                <div class="user-archive-content">
